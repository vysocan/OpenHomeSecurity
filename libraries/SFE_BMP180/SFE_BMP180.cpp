...
uint8_t SFE_BMP180::startTemperature(void)
...
uint8_t SFE_BMP180::getTemperature(float &T)
...
uint8_t SFE_BMP180::startPressure(char oversampling)
...
uint8_t SFE_BMP180::getPressure(float &P, float &T)
...
float SFE_BMP180::sealevel(float P, float A)
...
float SFE_BMP180::altitude(float P, float P0)
