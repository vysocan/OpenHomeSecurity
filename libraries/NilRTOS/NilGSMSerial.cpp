 ...
 * @param[in] baud rate
 */
void NilGSMSerialClass::begin(unsigned long baud) {
 ...
 * @return 1
 */
size_t NilGSMSerialClass::write(uint8_t b) {
 ...
 *
 */
NilGSMSerialClass NilGSMSerial;
